...
Meteor.publish('ppos.invoiceTransactionIn7days', function invoiceTransactionIn7days(selector, options) {
    this.unblock();
    if (this.userId) {
...
Meteor.publish('ppos.receivePaymentTransactionIn7days', function receivePaymentTransactionIn7days(selector, options) {
    this.unblock();
    if (this.userId) {
        let startOfWeek = moment().startOf('weeks').toDate();
        let endOfWeek = moment().endOf('weeks').toDate();
...
Meteor.publish('ppos.enterBillTransactionIn7days', function enterBillTransactionIn7days(selector, options) {
    this.unblock();
    if (this.userId) {
        let startOfWeek = moment().startOf('weeks').toDate();
        let endOfWeek = moment().endOf('weeks').toDate();
...
Meteor.publish('ppos.groupInvoiceTransactionIn7days', function groupInvoiceTransactionIn7days(selector, options) {
    this.unblock();
    if (this.userId) {
        let startOfWeek = moment().startOf('weeks').toDate();
        let endOfWeek = moment().endOf('weeks').toDate();
...
Meteor.publish('ppos.payBillTransactionIn7days', function payBillTransactionIn7days(selector, options) {
    this.unblock();
    if (this.userId) {
        let startOfWeek = moment().startOf('weeks').toDate();
        let endOfWeek = moment().endOf('weeks').toDate();
...
Meteor.publish('ppos.groupBillTransactionIn7days', function groupBillTransactionIn7days(selector, options) {
    this.unblock();
    if (this.userId) {
        let startOfWeek = moment().startOf('weeks').toDate();
        let endOfWeek = moment().endOf('weeks').toDate();
