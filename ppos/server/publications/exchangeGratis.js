...
Meteor.publish('ppos.exchangeGratis', function cementExchangeGratis(selector, options) {
    this.unblock();
...
Meteor.publish('ppos.activeExchangeGratis', function cementActiveSaleOrder(selector) {
    if (this.userId) {
