...
Meteor.publish('ppos.order', function simpleOrder(selector, options) {
    this.unblock();
...
Meteor.publish('ppos.receivePayment', function cementReceivePayment(selector = {}) {
    this.unblock();
...
Meteor.publish('ppos.saleOrderReceivePayment', function saleOrderReceivePayment(selector = {}) {
    this.unblock();
...
Meteor.publish('ppos.activeOrders', function cementActiveOrder(selector) {
    this.unblock();
    new SimpleSchema({
        selector: {type: Object, blackbox: true},
        // options: {type: Object, blackbox: true}
