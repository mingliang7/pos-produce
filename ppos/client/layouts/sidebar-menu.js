...
Template.PPOS_sidebarMenu.helpers({
    // customer
    customerList(){
    ...
    // },
    billByItem() {
        return `/cement/report/enterBillByItemReport?date=${moment().startOf('days').format('YYYY-MM-DD HH:mm:ss')},${moment().endOf('days').format('YYYY-MM-DD HH:mm:ss')}&branchId=${Session.get('currentBranch')}`;
    },
    billByVendor() {
    ...
    stockDetail(){
        return `/cement/report/stockDetail?date=${moment().endOf('days').format('YYYY-MM-DD HH:mm:ss')},${moment().endOf('days').format('YYYY-MM-DD HH:mm:ss')}&branch=${Session.get('currentBranch')}`;
    }
});