...
SelectOptMethods.stockLocation = new ValidatedMethod({
    name: 'ppos.selectOptMethods.stockLocation',
    validate: null,
    run(options) {
...
SelectOptMethods.stockLocationMapping = new ValidatedMethod({
    name: 'ppos.selectOptMethods.stockLocationMapping',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.lookupInvoice = new ValidatedMethod({
    name: 'ppos.selectOptMethods.lookupInvoice',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.rep = new ValidatedMethod({
    name: 'ppos.selectOptMethods.rep',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.customer = new ValidatedMethod({
    name: 'ppos.selectOptMethods.customer',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.vendorByBranch = new ValidatedMethod({
    name: 'ppos.selectOptMethods.vendorByBranch',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.saleOrder = new ValidatedMethod({
    name: 'ppos.selectOptMethods.saleOrder',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.purchaseOrderDetail = new ValidatedMethod({
    name: 'ppos.selectOptMethods.purchaseOrderDetail',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.truck = new ValidatedMethod({
    name: 'ppos.selectOptMethods.truck',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.vendor = new ValidatedMethod({
    name: 'ppos.selectOptMethods.vendor',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.item = new ValidatedMethod({
    name: 'ppos.selectOptMethods.item',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
            ...
            let data = Item.find(selector, {limit: 50});
            data.forEach(function (value) {
                let label = value.name;
                list.push({label: label, value: value._id});
            });
...
SelectOptMethods.order = new ValidatedMethod({
    name: 'ppos.selectOptMethods.order',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.user = new ValidatedMethod({
    name: 'ppos.selectOptMethods.user',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.branch = new ValidatedMethod({
    name: 'ppos.selectOptMethods.branch',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.transferMoneybranch = new ValidatedMethod({
    name: 'ppos.selectOptMethods.transferMoneyBranch',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.branchListExcludeCurrent = new ValidatedMethod({
    name: 'ppos.selectOptMethods.branchListExcludeCurrent',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.paymentGroup = new ValidatedMethod({
    name: 'ppos.selectOptMethods.paymentGroup',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.term = new ValidatedMethod({
    name: 'ppos.selectOptMethods.term',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
...
SelectOptMethods.settingUser = new ValidatedMethod({
    name: 'ppos.selectOptMethods.settingUser',
    validate: null,
    run(options) {
        if (!this.isSimulation) {
            this.unblock();
