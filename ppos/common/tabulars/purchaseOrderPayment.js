...
tabularOpts.name = 'ppos.purchaseOrderPaymentTransaction';
tabularOpts.collection = PurchaseOrderPayment;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.PPOS_purchaseOrderPaymentTransactionAction},
    {data: "_id", title: '#ID'},
