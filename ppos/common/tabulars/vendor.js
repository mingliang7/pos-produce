...
tabularOpts.name = 'ppos.vendor';
tabularOpts.collection = Vendors;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.PPOS_vendorAction},
    {data: "_id", title: "ID"},
    ...
    {title: '', tmpl: Meteor.isClient && Template.PPOS_vendorButtonAction}
];
