...
tabularOpts.name = 'ppos.saleOrderPaymentTransaction';
tabularOpts.collection = SaleOrderReceivePayment;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.PPOS_soPaymentTransactionAction},
    {data: "_id", title: '#ID'},
    ...
    },
    {
        ...
        render: function (val, type, doc) {
            let recalDueAmountWithDiscount = val  + (doc.discount || 0) + (doc.cod || 0) + (doc.benefit || 0);
