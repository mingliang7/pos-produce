...
export const ReceiveItems = new Mongo.Collection("ppos_receiveItems");
...
Meteor.startup(function () {
    ReceiveItems.itemsSchema.i18n("ppos.receiveItem.schema");
    ReceiveItems.schema.i18n("ppos.receiveItem.schema");
