...
export const PurchaseOrder = new Mongo.Collection("ppos_purchaseOrder");
...
Meteor.startup(function () {
    PurchaseOrder.itemsSchema.i18n("ppos.purchaseOrder.schema");
    PurchaseOrder.schema.i18n("ppos.purchaseOrder.schema");
