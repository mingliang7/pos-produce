...
export const RingPullTransfers = new Mongo.Collection("ppos_ringPullTransfers");
// Items sub schema
...
RingPullTransfers.schema = new SimpleSchema({
    ...
    toBranchId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                ...
                optionsMethod: 'ppos.selectOptMethods.branchListExcludeCurrent',
    ...
    stockLocationId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                uniPlaceholder: 'Select One',
                optionsMethod: 'ppos.selectOptMethods.stockLocation',
                optionsMethodParams: function () {
                    if (Meteor.isClient) {
...
Meteor.startup(function () {
    RingPullTransfers.itemsSchema.i18n("ppos.ringPullTransfer.schema");
    RingPullTransfers.schema.i18n("ppos.ringPullTransfer.schema");
