...
// Declare template
let indexTmpl = Template.PPOS_groupInvoiceList,
    actionTmpl = Template.PPOS_groupInvoiceListAction,
    editTmpl = Template.PPOS_groupInvoiceListEdit,
    showTmpl = Template.PPOS_groupInvoiceListShow;
...
AutoForm.addHooks([
    'PPOS_groupInvoiceListNew',
    'PPOS_groupInvoiceListEdit'
], hooksObject);
