...
// Declare template
let indexTmpl = Template.PPOS_payBillTransaction,
    actionTmpl = Template.PPOS_payBillTransactionAction,
    editTmpl = Template.PPOS_payBillTransactionEdit,
    showTmpl = Template.PPOS_payBillTransactionShow;
...
AutoForm.addHooks([
    'PPOS_payBillTransactionNew',
    'PPOS_payBillTransactionEdit'
], hooksObject);
