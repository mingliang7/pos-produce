...
// Declare template
var itemsTmpl = Template.PPOS_prepaidOrderItems,
    actionItemsTmpl = Template.PPOS_prepaidOrderItemsAction;
editItemsTmpl = Template.PPOS_prepaidOrderItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'ppos.prepaidOrder.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.prepaidOrder.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('ppos.prepaidOrder.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_prepaidOrderItemsEdit'], hooksObject);
