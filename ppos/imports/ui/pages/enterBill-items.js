...
// Declare template
let itemsTmpl = Template.PPOS_enterBillItems,
    actionItemsTmpl = Template.PPOS_enterBillItemsAction,
    editItemsTmpl = Template.PPOS_enterBillItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'ppos.enterBill.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.enterBill.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    /*  'click .js-destroy-item': function (event, instance) {
     ...
     title: TAPi18n.__('ppos.enterBill.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_enterBillItemsEdit'], hooksObject);
