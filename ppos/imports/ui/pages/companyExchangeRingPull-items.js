...
// Declare template
var itemsTmpl = Template.PPOS_companyExchangeRingPullItems,
    actionItemsTmpl = Template.PPOS_companyExchangeRingPullItemsAction,
    editItemsTmpl = Template.PPOS_companyExchangeRingPullItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'ppos.companyExchangeRingPull.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.companyExchangeRingPull.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        event.preventDefault();
        let itemDoc = this;
        if (AutoForm.getFormId() == "PPOS_companyExchangeRingPullUpdate") { //check if update form
            swal({
                    title: "Are you sure?",
                    text: "លុបទំនិញមួយនេះ?",
            ...
            destroyAction(
                itemsCollection, {
                    ...
                    title: TAPi18n.__('ppos.companyExchangeRingPull.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_companyExchangeRingPullItemsEdit'], hooksObject);
