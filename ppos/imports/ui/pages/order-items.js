...
// Declare template
var itemsTmpl = Template.PPOS_orderItems,
    actionItemsTmpl = Template.PPOS_orderItemsAction,
    editItemsTmpl = Template.PPOS_orderItemsEdit,
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'ppos.order.schema';
...
itemsTmpl.events({
    ...
    'click .js-destroy-item': function (event, instance) {
        ...
        let itemDoc = this;
        if (AutoForm.getFormId() == 'PPOS_orderEdit') { // check if update form
...
AutoForm.addHooks(['PPOS_orderItemsEdit'], hooksObject);
