...
// Declare template
var itemsTmpl = Template.PPOS_exchangeGratisItems,
    actionItemsTmpl = Template.PPOS_exchangeGratisItemsAction,
    editItemsTmpl = Template.PPOS_exchangeGratisItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'ppos.exchangeGratis.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.exchangeGratis.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('ppos.exchangeGratis.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_exchangeGratisItemsEdit'], hooksObject);
