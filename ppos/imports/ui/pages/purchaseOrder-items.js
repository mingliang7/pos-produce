...
// Declare template
var itemsTmpl = Template.PPOS_purchaseOrderItems,
    actionItemsTmpl = Template.PPOS_purchaseOrderItemsAction;
editItemsTmpl = Template.PPOS_purchaseOrderItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'ppos.purchaseOrder.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.purchaseOrder.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('ppos.purchaseOrder.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_purchaseOrderItemsEdit'], hooksObject);
