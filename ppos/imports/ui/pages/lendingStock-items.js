...
// Declare template
var itemsTmpl = Template.PPOS_lendingStockItems,
    actionItemsTmpl = Template.PPOS_lendingStockItemsAction,
    editItemsTmpl = Template.PPOS_lendingStockItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'ppos.lendingStock.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.lendingStock.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    /*  'click .js-destroy-item': function (event, instance) {
     ...
     title: TAPi18n.__('ppos.lendingStock.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_lendingStockItemsEdit'], hooksObject);
