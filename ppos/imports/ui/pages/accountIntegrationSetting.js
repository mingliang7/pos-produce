...
let indexTmpl = Template.PPOS_accountIntegrationSetting;
indexTmpl.onCreated(function () {
    Meteor.subscribe('ppos.accountIntegrationSetting');
...
AutoForm.addHooks([
    'PPOS_accountIntegrationSettingNew',
    'PPOS_accountIntegrationSettingEdit'
], hooksObject);
