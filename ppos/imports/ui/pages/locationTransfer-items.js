...
// Declare template
var itemsTmpl = Template.PPOS_locationTransferItems,
    actionItemsTmpl = Template.PPOS_locationTransferItemsAction,
    editItemsTmpl = Template.PPOS_locationTransferItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'ppos.locationTransfer.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.locationTransfer.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('ppos.locationTransfer.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_locationTransferItemsEdit'], hooksObject);
