...
// Declare template
let indexTmpl = Template.PPOS_purchaseOrderPaymentTransaction,
    actionTmpl = Template.PPOS_purchaseOrderPaymentTransactionAction,
    editTmpl = Template.PPOS_purchaseOrderPaymentTransactionEdit,
    showTmpl = Template.PPOS_purchaseOrderShowInPoPayment;
...
AutoForm.addHooks([
    'PPOS_purchaseOrderPaymentTransactionNew',
    'PPOS_purchaseOrderPaymentTransactionEdit'
], hooksObject);
