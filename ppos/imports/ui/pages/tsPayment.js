...
let indexTmpl = Template.PPOS_tsPayment,
    showInvoiceTmpl = Template.PPOS_invoiceShowInTsPayment;
    ...
    this.autorun(function () {
        if (Session.get('customerId')) {
            ...
            if (customer && customer.termId) {
                invoiceSub = Meteor.subscribe('ppos.activeTsInvoices', {
        ...
        if (Session.get('invoices')) {
            Meteor.subscribe('ppos.tsPayment', {
                invoiceId: {
