...
// Declare template
var itemsTmpl = Template.PPOS_ringPullTransferItems,
    actionItemsTmpl = Template.PPOS_ringPullTransferItemsAction;
editItemsTmpl = Template.PPOS_ringPullTransferItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'ppos.ringPullTransfer.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('ppos.ringPullTransfer.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        event.preventDefault();
        let itemDoc = this;
        if (AutoForm.getFormId() == "PPOS_ringPullTransferUpdate") { //check if update form
            swal({
                    title: "Are you sure?",
                    text: "លុបទំនិញមួយនេះ?",
            ...
            destroyAction(
                itemsCollection, {
                    ...
                    title: TAPi18n.__('ppos.ringPullTransfer.schema.itemId.label'),
...
AutoForm.addHooks(['PPOS_ringPullTransferItemsEdit'], hooksObject);
