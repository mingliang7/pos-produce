...
// Declare template
let indexTmpl = Template.PPOS_soPaymentTransaction,
    actionTmpl = Template.PPOS_soPaymentTransactionAction,
    editTmpl = Template.PPOS_soPaymentTransactionEdit,
    showTmpl = Template.PPOS_soPaymentTransactionShow;
...
AutoForm.addHooks([
    'PPOS_soPaymentTransactionListNew',
    'PPOS_soPaymentTransactionListEdit'
], hooksObject);
