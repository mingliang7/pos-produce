...
// Declare template
let formTmpl = Template.PPOS_customerReport,
    genTmpl = Template.PPOS_customerReportGen;
...
let hooksObject = {
    ...
    onSuccess: function (formType, result) {
        ...
        let path = FlowRouter.path("ppos.customerReportGen", params, queryParams);
...
AutoForm.addHooks('PPOS_customerReport', hooksObject);
