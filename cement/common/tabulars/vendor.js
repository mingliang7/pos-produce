...
tabularOpts.name = 'cement.vendor';
tabularOpts.collection = Vendors;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.Cement_vendorAction},
    {data: "_id", title: "ID"},
    ...
    {title: '', tmpl: Meteor.isClient && Template.Cement_vendorButtonAction}
];
