...
tabularOpts.name = 'cement.customer';
tabularOpts.collection = Customers;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.Cement_customerAction},
    {data: "_id", title: "ID"},
    ...
    {title: '', tmpl: Meteor.isClient && Template.Cement_customerButtonAction}
];
