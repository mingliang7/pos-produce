...
// Page
Meteor.isClient && require('../../imports/ui/pages/tsSoPaymentList.html');

tabularOpts.name = 'cement.tsSoPaymentList';
tabularOpts.collection = TSSOPayment;
tabularOpts.columns = [
    {title: '<i class="fa fa-bars"></i>', tmpl: Meteor.isClient && Template.Cement_tsPaymentListAction},
    {data: "_id", title: '#ID'},
...
export const TsSoPaymentListTabular = new Tabular.Table(tabularOpts);
