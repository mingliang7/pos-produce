...
export const PurchaseOrder = new Mongo.Collection("cement_purchaseOrder");
...
Meteor.startup(function () {
    PurchaseOrder.itemsSchema.i18n("cement.purchaseOrder.schema");
    PurchaseOrder.schema.i18n("cement.purchaseOrder.schema");
