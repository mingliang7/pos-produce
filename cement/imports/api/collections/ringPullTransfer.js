...
export const RingPullTransfers = new Mongo.Collection("cement_ringPullTransfers");
// Items sub schema
...
RingPullTransfers.schema = new SimpleSchema({
    ...
    toBranchId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                ...
                optionsMethod: 'cement.selectOptMethods.branchListExcludeCurrent',
    ...
    stockLocationId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                uniPlaceholder: 'Select One',
                optionsMethod: 'cement.selectOptMethods.stockLocation',
                optionsMethodParams: function () {
                    if (Meteor.isClient) {
...
Meteor.startup(function () {
    RingPullTransfers.itemsSchema.i18n("cement.ringPullTransfer.schema");
    RingPullTransfers.schema.i18n("cement.ringPullTransfer.schema");
