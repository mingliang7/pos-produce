...
export const ReceiveItems = new Mongo.Collection("cement_receiveItems");
...
Meteor.startup(function () {
    ReceiveItems.itemsSchema.i18n("cement.receiveItem.schema");
    ReceiveItems.schema.i18n("cement.receiveItem.schema");
