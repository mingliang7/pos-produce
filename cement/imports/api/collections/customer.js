...
export const Customers = new Mongo.Collection("cement_customers");
...
Customers.schema = new SimpleSchema({
    ...
    termId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                uniPlaceholder: 'Select One',
                optionsMethod: 'cement.selectOptMethods.term'
            }
        }
    },
    paymentGroupId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                uniPlaceholder: 'Select One',
                optionsMethod: 'cement.selectOptMethods.paymentGroup'
            }
        }
    },
    creditLimit: {
    ...
    repId: {
        ...
        autoform: {
            ...
            afFieldInput: {
                uniPlaceholder: 'Select One',
                optionsMethod: 'cement.selectOptMethods.rep',
...
Meteor.startup(function () {
    Customers.schema.i18n("cement.customer.schema");
