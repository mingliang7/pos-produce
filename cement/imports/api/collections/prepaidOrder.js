...
export const PrepaidOrders = new Mongo.Collection("cement_prepaidOrders");
...
Meteor.startup(function () {
    PrepaidOrders.itemsSchema.i18n("cement.prepaidOrder.schema");
    PrepaidOrders.schema.i18n("cement.prepaidOrder.schema");
