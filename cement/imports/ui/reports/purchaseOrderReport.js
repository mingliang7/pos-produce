...
//page
import './purchaseOrderReport.html';
//import DI
import  'printthis';
//import collection
import {purchaseOrderReportSchema} from '../../api/collections/reports/purchaseOrderReport';

//methods
import {purchaseOrderReport} from '../../../common/methods/reports/purchaseOrderReport';
import RangeDate from "../../api/libs/date";
//state
let paramsState = new ReactiveVar();
let invoiceData = new ReactiveVar();
//declare template
let indexTmpl = Template.Cement_purchaseOrderReport,
    invoiceDataTmpl = Template.purchaseOrderReportData;
Tracker.autorun(function () {
    if (paramsState.get()) {
        ...
        purchaseOrderReport.callPromise(paramsState.get())
...
indexTmpl.helpers({
    schema(){
        return purchaseOrderReportSchema;
    },
    fromDate(){
...
invoiceDataTmpl.helpers({
    ...
    display(col){
        ...
        this.displayFields.forEach(function (obj) {
            if (obj.field == 'purchaseOrderDate') {
