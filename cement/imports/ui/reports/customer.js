...
// Declare template
let formTmpl = Template.Cement_customerReport,
    genTmpl = Template.Cement_customerReportGen;
...
let hooksObject = {
    ...
    onSuccess: function (formType, result) {
        ...
        let path = FlowRouter.path("cement.customerReportGen", params, queryParams);
...
AutoForm.addHooks('Cement_customerReport', hooksObject);
