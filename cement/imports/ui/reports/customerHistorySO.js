...
//methods
import {customerHistorySOReport} from '../../../common/methods/reports/customerHistorySO';
import RangeDate from "../../api/libs/date";
//state
let paramsState = new ReactiveVar();
let invoiceData = new ReactiveVar();
//declare template
let indexTmpl = Template.Cement_customerHistorySO,
    invoiceDataTmpl = Template.customerHistorySOData;
Tracker.autorun(function () {
    if (paramsState.get()) {
        ...
        customerHistorySOReport.callPromise(paramsState.get())
