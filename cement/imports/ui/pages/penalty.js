...
// Declare template
let indexTmpl = Template.Cement_penalty,
    actionTmpl = Template.Cement_penaltyAction,
    newTmpl = Template.Cement_penaltyNew,
    editTmpl = Template.Cement_penaltyEdit,
    showTmpl = Template.Cement_penaltyShow;
...
indexTmpl.events({
    'click .js-create' (event, instance) {
        alertify.penalty(fa('plus', TAPi18n.__('cement.penalty.title')), renderTemplate(newTmpl));
    },
    ...
    'click .js-destroy' (event, instance) {
        ...
        destroyAction(
            Penalty,
            {_id: id},
            {title: TAPi18n.__('cement.penalty.title'), itemTitle: id});

    },
    'click .js-display' (event, instance) {
        alertify.penaltyShow(fa('eye', TAPi18n.__('cement.penalty.title')), renderTemplate(showTmpl, this));
    }
});
