...
// Declare template
var itemsTmpl = Template.Cement_lendingStockItems,
    actionItemsTmpl = Template.Cement_lendingStockItemsAction,
    editItemsTmpl = Template.Cement_lendingStockItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'cement.lendingStock.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('cement.lendingStock.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    /*  'click .js-destroy-item': function (event, instance) {
     ...
     title: TAPi18n.__('cement.lendingStock.schema.itemId.label'),
...
AutoForm.addHooks(['Cement_lendingStockItemsEdit'], hooksObject);
