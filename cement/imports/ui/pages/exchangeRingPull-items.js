...
var itemsTmpl = Template.Cement_exchangeRingPullItems,
    actionItemsTmpl = Template.Cement_exchangeRingPullItemsAction,
    editItemsTmpl = Template.Cement_exchangeRingPullItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'cement.exchangeRingPull.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('cement.exchangeRingPull.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        event.preventDefault();
        let itemDoc = this;
        if (AutoForm.getFormId() == "Cement_exchangeRingPullUpdate") { //check if update form
            swal({
                title: "Are you sure?",
                text: "លុបទំនិញមួយនេះ?",
            ...
            destroyAction(
                itemsCollection, {
                    ...
                    title: TAPi18n.__('cement.exchangeRingPull.schema.itemId.label'),
...
AutoForm.addHooks(['Cement_exchangeRingPullItemsEdit'], hooksObject);
