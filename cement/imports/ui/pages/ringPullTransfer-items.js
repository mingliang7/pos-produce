...
// Declare template
var itemsTmpl = Template.Cement_ringPullTransferItems,
    actionItemsTmpl = Template.Cement_ringPullTransferItemsAction;
editItemsTmpl = Template.Cement_ringPullTransferItemsEdit;
...
itemsTmpl.helpers({
    ...
    tableSettings: function () {
        let i18nPrefix = 'cement.ringPullTransfer.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('cement.ringPullTransfer.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        event.preventDefault();
        let itemDoc = this;
        if (AutoForm.getFormId() == "Cement_ringPullTransferUpdate") { //check if update form
            swal({
                    title: "Are you sure?",
                    text: "លុបទំនិញមួយនេះ?",
            ...
            destroyAction(
                itemsCollection, {
                    ...
                    title: TAPi18n.__('cement.ringPullTransfer.schema.itemId.label'),
...
AutoForm.addHooks(['Cement_ringPullTransferItemsEdit'], hooksObject);
