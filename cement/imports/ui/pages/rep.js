...
// Declare template
let indexTmpl = Template.Cement_rep,
    actionTmpl = Template.Cement_repAction,
    newTmpl = Template.Cement_repNew,
    editTmpl = Template.Cement_repEdit,
    showTmpl = Template.Cement_repShow;
...
indexTmpl.events({
    'click .js-create' (event, instance) {
        alertify.rep(fa('plus', TAPi18n.__('cement.rep.title')), renderTemplate(newTmpl));
    },
    'click .js-update' (event, instance) {
        alertify.rep(fa('pencil', TAPi18n.__('cement.rep.title')), renderTemplate(editTmpl, this));
    },
    ...
    'click .js-display' (event, instance) {
        alertify.repShow(fa('eye', TAPi18n.__('cement.rep.title')), renderTemplate(showTmpl, this));
    }
});
