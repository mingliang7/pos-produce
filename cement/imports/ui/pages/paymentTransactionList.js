...
// Declare template
let indexTmpl = Template.Cement_paymentTransaction,
    actionTmpl = Template.Cement_paymentTransactionAction,
    editTmpl = Template.Cement_paymentTransactionEdit,
    showTmpl = Template.Cement_paymentTransactionShow;
...
AutoForm.addHooks([
    'Cement_paymentTransactionListNew',
    'Cement_paymentTransactionListEdit'
], hooksObject);
