...
// Declare template
let indexTmpl = Template.Cement_home;
...
indexTmpl.onCreated(function () {
    ...
    this.autorun(()=> {
        ...
        if (type == 'invoice' || type == 'receivePayment' || type == 'groupInvoice' || type == 'enterBill' || type == 'payBill' || type == 'groupBill') {
            this.subscription = Meteor.subscribe(`cement.${type}TransactionIn7days`, {branchId: Session.get('currentBranch')},{limit: limit});
        }
...
indexTmpl.onRendered(function () {
    ...
    this.autorun(()=> {
        Meteor.call('cementChart', {}, (err, result)=> {
            let chartOpts = {
                chart: {
                    type: 'column'
                },
