...
let indexTmpl = Template.Cement_order,
    ...
    newTmpl = Template.Cement_orderNew,
    editTmpl = Template.Cement_orderEdit,
    showTmpl = Template.Cement_orderShow;
...
indexTmpl.events({
    ...
    'click .js-display' (event, instance) {
        ...
        Meteor.call('saleOrderShow', {_id: this._id}, function (err, result) {
            ...
            alertify.orderShow(fa('eye', TAPi18n.__('cement.order.title')), renderTemplate(showTmpl, result));
        });
    },
    'click .js-invoice' (event, instance) {
        let params = {};
        let queryParams = {orderId: this._id};
        let path = FlowRouter.path("cement.orderReportGen", params, queryParams);
