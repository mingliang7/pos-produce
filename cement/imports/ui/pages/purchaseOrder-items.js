...
// Declare template
var itemsTmpl = Template.Cement_purchaseOrderItems,
    actionItemsTmpl = Template.Cement_purchaseOrderItemsAction;
editItemsTmpl = Template.Cement_purchaseOrderItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'cement.purchaseOrder.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('cement.purchaseOrder.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('cement.purchaseOrder.schema.itemId.label'),
...
AutoForm.addHooks(['Cement_purchaseOrderItemsEdit'], hooksObject);
