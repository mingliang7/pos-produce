...
// Declare template
var itemsTmpl = Template.Cement_exchangeGratisItems,
    actionItemsTmpl = Template.Cement_exchangeGratisItemsAction,
    editItemsTmpl = Template.Cement_exchangeGratisItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'cement.exchangeGratis.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('cement.exchangeGratis.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('cement.exchangeGratis.schema.itemId.label'),
...
AutoForm.addHooks(['Cement_exchangeGratisItemsEdit'], hooksObject);
