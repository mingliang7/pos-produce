...
// Declare template
var itemsTmpl = Template.Cement_locationTransferItems,
    actionItemsTmpl = Template.Cement_locationTransferItemsAction,
    editItemsTmpl = Template.Cement_locationTransferItemsEdit;
...
itemsTmpl.helpers({
    tableSettings: function () {
        let i18nPrefix = 'cement.locationTransfer.schema';
...
itemsTmpl.events({
    ...
    'click .js-update-item': function (event, instance) {
        alertify.item(fa('pencil', TAPi18n.__('cement.locationTransfer.schema.itemId.label')), renderTemplate(editItemsTmpl, this));
    },
    'click .js-destroy-item': function (event, instance) {
        destroyAction(
            itemsCollection, {
                ...
                title: TAPi18n.__('cement.locationTransfer.schema.itemId.label'),
...
AutoForm.addHooks(['Cement_locationTransferItemsEdit'], hooksObject);
