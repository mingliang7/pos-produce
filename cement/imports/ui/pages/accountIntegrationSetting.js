...
let indexTmpl = Template.Cement_accountIntegrationSetting;
indexTmpl.onCreated(function () {
    Meteor.subscribe('cement.accountIntegrationSetting');
...
AutoForm.addHooks([
    'Cement_accountIntegrationSettingNew',
    'Cement_accountIntegrationSettingEdit'
], hooksObject);
