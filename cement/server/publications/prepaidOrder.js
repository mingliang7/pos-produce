...
Meteor.publish('cement.prepaidOrder', function cementPrepaidOrder(selector, options) {
    this.unblock();
...
Meteor.publish('cement.activePrepaidOrder', function cementActiveSaleOrder(selector) {
    if (this.userId) {
